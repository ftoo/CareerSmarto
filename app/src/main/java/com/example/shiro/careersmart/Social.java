...
public class Social extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myList = (ListView)findViewById(R.id.s_list);
        next = (ImageButton)findViewById(R.id.s_btnNext);
        back = (ImageButton)findViewById(R.id.s_btnBack);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_multiple_choice, getResources().getStringArray(R.array.Social));
...
//        });
        next.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Social.this, numberOfItemsSelected+" items selected ", Toast.LENGTH_LONG).show();
                ResultClass rs = ResultClass.getInstance();
                rs.results.put("social", numberOfItemsSelected);
                Intent intent = new Intent(Social.this, Entreprenural.class);
...
// TODO Auto-generated method stub
                Intent intent = new Intent(Social.this, Investigative.class);
                startActivity(intent);
            }
        });
