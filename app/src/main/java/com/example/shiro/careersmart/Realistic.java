...
public class Realistic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myList = (ListView)findViewById(R.id.r_list);
       next = (ImageButton)findViewById(R.id.r_btnNext);
        back = (ImageButton)findViewById(R.id.r_btnBack);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_multiple_choice, getResources().getStringArray(R.array.Realistic));
...
//        });
      next.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Realistic.this, numberOfItemsSelected+" items selected ", Toast.LENGTH_LONG).show();
               ResultClass rs = ResultClass.getInstance();
               rs.results.put("realistic",numberOfItemsSelected);
                Intent intent = new Intent(Realistic.this, Artistic.class);
...
// TODO Auto-generated method stub
                Intent intent = new Intent(Realistic.this, NavActivity.class);
                startActivity(intent);
            }
        });
